...
from backend.routers.workspace_preferences import router as workspace_preferences_router
...
api_router.include_router(workspace_preferences_router, tags=["workspace"])
